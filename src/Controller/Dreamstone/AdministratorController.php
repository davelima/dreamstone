...
class AdministratorController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $repository = $this->getDoctrine()->getRepository('App:Administrator');
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($administrator->getPhoto() && $administrator->getPhoto() instanceof UploadedFile) {
                ...
                $image->save(__DIR__ . '/../../../public/uploads/', $fileName);
    ...
    public function editAction(Request $request, $id)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $administrator = $em->getRepository('App:Administrator')->find($id);
        $form = $this->createForm(AdministratorType::class, $administrator);
